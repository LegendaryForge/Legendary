...
final class ActivationServiceBeginsSessionOnGateAllowTest {
    ...
    @Test
    void allowBeginsSessionAndReturnsSuccess() {
        ...
        // With empty inputs, Stormseeker currently denies by default.
        // This test is only verifying Phase 3 request shape + service plumbing.
