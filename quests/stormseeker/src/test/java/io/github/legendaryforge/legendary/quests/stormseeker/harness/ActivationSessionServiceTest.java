...
import io.github.legendaryforge.legendary.quests.stormseeker.quest.StormseekerQuestSteps;
...
public final class ActivationSessionServiceTest {
    ...
    void beginCreatesSessionEvenWhenActivationGateKeyProvided() {
        ...
        io.github.legendaryforge.legendary.quests.stormseeker.StormseekerWiring.registerGates(gates);
