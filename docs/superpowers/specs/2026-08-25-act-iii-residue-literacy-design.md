...
`Environment` asset. It varies **32×** between environments and is essentially flat across
the 24 hours — 6 of the 9 storm-capable environments have identical odds in every hour.
