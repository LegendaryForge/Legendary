...
class CurrentGeometryTest {
    ...
    private static final CurrentParameters PARAMS = new CurrentParameters(4, 50, 16.0, 0.35, 24.0, 0.3);
    ...
    void zeroJitter_producesStraightArms() {
        CurrentParameters straight = new CurrentParameters(4, 20, 10.0, 0.0, 24.0, 0.3);
